...
def evaluate_etf(ter: Union[float, str], aum: Union[float, str], ret: Union[float, str]) -> Tuple[float, str, str, Dict[str, Dict[str, str]]]:
    ...
    if f_ret >= 15: s_ret, t_ret, c_ret = 10, "Eccellente (>= 15%)", col_exc
    elif f_ret >= 8: s_ret, t_ret, c_ret = 8, "Buono (>= 8%)", col_good
    elif f_ret >= 0: s_ret, t_ret, c_ret = 5, "Positivo (>= 0%)", col_fair
